...
class RewardServiceTest {
    ...
    @Test
    void summaries_areReturnedForCustomerInRepository() throws ExecutionException, InterruptedException {
        LocalDate startDate = LocalDate.now().minusMonths(3);
        LocalDate endDate = LocalDate.now();
        when(transactionRepository.findByTransactionDateBetween(startDate, endDate)).thenReturn(sampleTransaction());
    ...
    void getRewardSummaries_throwsWhenDateRangeIsInThePast() {
        ...
        assertThrows(DateRangeException.class,
                () -> rewardService.getRewardSummaries(invalidStartDate.toString(), invalidEndDate.toString()));
    }
    ...
    private static List<TransactionEntity> sampleTransaction() {
        return List.of(new TransactionEntity("T00014", "C005", "Nirmal Xavier", new BigDecimal("60.00"), LocalDate.of(2026, 7, 9)),
                new TransactionEntity("T00011", "C004", "David John", new BigDecimal("30.00"), LocalDate.of(2026, 6, 9)),
                new TransactionEntity("T00012", "C004", "David John", new BigDecimal("49.99"), LocalDate.of(2026, 6, 30)),
                new TransactionEntity("T0008", "C003", "Priya Sharma", new BigDecimal("310.00"), LocalDate.of(2026, 6, 11)),
                new TransactionEntity("T0009", "C003", "Priya Sharma", new BigDecimal("260.40"), LocalDate.of(2026, 6, 17)),
                new TransactionEntity("T00010", "C003", "Priya Sharma", new BigDecimal("180.00"), LocalDate.of(2026, 7, 29))
