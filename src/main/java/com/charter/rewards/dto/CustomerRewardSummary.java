...
/**
 * A customer's reward points broken down by month, plus the running total across the whole
 * reporting period.
 */
public record CustomerRewardSummary(String customerId, String customerName,
